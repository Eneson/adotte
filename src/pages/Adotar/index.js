    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.content} behavior={'padding'}>      
        ...
        <View style={styles.animaisDesc}>
                <View>
                  <View style={{marginTop: 10,flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',alignContent: 'center'}}>
                  ...
                  <View style={{marginTop:5}}>    
                    <Text style={[styles.descText,styles.textBold]}>Descrição:</Text>     
