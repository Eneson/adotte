  ...
  return ( 
    ...
    <View style={styles.container}>      
      ...
      <View style={styles.content}>
        ...
        {'\t'}Bem-vindo ao nosso aplicativo de adoção de animais! Este trabalho de conclusão de curso foi desenvolvido por Enerson Macêdo da Silva e Cristiane da Conceição Dias, alunos do IFPA Campus Itaituba.
        </Text>
        <Text style={styles.texto}>
